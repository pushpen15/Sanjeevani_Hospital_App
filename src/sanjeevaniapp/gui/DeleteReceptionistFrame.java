...
private void setComboBox(){
 ...
 try{   x=getAllRecepId();
    ...
    private void btnDeleteEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteEmpActionPerformed
      ...
      boolean x= deleteEmp(jcbEmpId.getSelectedItem().toString());
      ...
      {
          JOptionPane.showMessageDialog(null,"Deletion  UnSuccessful!","Success!",JOptionPane.INFORMATION_MESSAGE); 
          return;
      }
       }
     catch (SQLException ex) {
